<div class="product product-single">
    <div class="product-thumb">
        ...
        <a href="{{$product->mypath()}}" class="main-btn quick-view"><i class="fa fa-search-plus"></i>Quick view</a>
        <img src="{{asset('product_images/'.$product->displayImage->image)}}" alt="">
    </div>
    <div class="product-body">
        <h3 class="product-price">
            {{$product->price}}<span><img style="display: inline" width="18px" src="{{asset('frontend/img/taka.png')}}"
                    alt=""></span>
            @php
            $price = $product->price;
            ...
            @endphp
            <del class="product-old-price">{{$oldPrice}}<span><img style="display: inline" width="15px"
                        src="{{asset('frontend/img/taka.png')}}" alt=""></span></del>
        </h3>
        ...
        @endif
        {{-- <h2 class="product-name"><a href="{{route('nproduct',[$product->id,slug('title')])}}">{{$product->title}}</a>
        </h2> --}}
        ...
        <div class="product-btns">
            ...
            <button style="margin-left:5px" id="add_to_cart" value="{{$product->id}}"
                class="primary-btn add_to_cart"></i> Add
                to Cart </button>
        </div>
    </div>
</div>